...
run_metasv.py {options} \\
  ...
  {isize_mean} \\
  {isize_sd}""".format(
        options=global_conf.get('metasv_ensemble', 'options'),
        threads=global_conf.get('metasv_ensemble', 'threads'),
        genome=global_conf.get('metasv_ensemble', 'genome_fasta', type='filepath'),
        lumpy=lumpy,
        manta=manta,
